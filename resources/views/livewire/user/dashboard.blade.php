    ...
    <div class="card card-body border-0 shadow table-wrapper table-responsive mt-4">
        ...
        <div class="my-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-primary btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#tambahAktivitasBulanan">
                    Tambah
                </button>
            </div>
            <form>
                ...
                <div class="my-2 mb-4">
                    <div class="row mb-3">
                        <div class="col-md-12" wire:ignore>
                            ...
                            <select id="subkegiatan" wire:model.live="selectedSubkegiatan" class="form-select select2">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" wire:model.live="isPerjalananDinas">
                        ...
                        <div class="col-md-6 order-md-last mt-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="tanggal_mulai" class="form-label">Tanggal @if($isPerjalananDinas) Mulai @endif</label>
                                    <input type="date" class="form-control" id="tanggal_mulai" wire:model.defer="tanggal_mulai">
                                    @error('tanggal_mulai') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                @if($isPerjalananDinas)
                                <div class="col-md-6">
                                    <label for="tanggal_selesai" class="form-label">Tanggal Selesai</label>
                                    <input type="date" class="form-control" id="tanggal_selesai" wire:model.defer="tanggal_selesai" {{ $isPerjalananDinas ? '' : 'disabled' }}>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" value="{{ $pegawai->id }}" id="pegawai-{{ $pegawai->id }}" wire:model.live="selectedPegawai[]">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="simpanAktivitas">Simpan</button>
                </div>
            </form>
            <hr>
            <br>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            [{{ $aktivitas->kegiatan->subprogram->program->kode_rekening_program }}] {{ $aktivitas->kegiatan->subprogram->program->nama_program }}<br>
                            &nbsp;&nbsp;[{{ $aktivitas->kegiatan->subprogram->kode_rekening_subprogram }}] {{ $aktivitas->kegiatan->subprogram->nama_subprogram }}<br>
                            &nbsp;&nbsp;&nbsp;&nbsp;[{{ $aktivitas->kegiatan->kode_rekening_kegiatan }}] {{ $aktivitas->kegiatan->nama_kegiatan }}<br>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[{{ $aktivitas->kegiatan->subkegiatan->kode_rekening_subkegiatan }}] {{ $aktivitas->kegiatan->subkegiatan->nama_subkegiatan }}
                        </td>
                        <td>
                            {{ $aktivitas->tempat }} <br>
                            {{ date('d-m-Y', strtotime($aktivitas->tanggal_mulai)) }} -
                                                                        ...
                                                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSubKegiatan{{ $subkegiatan->id }}" aria-expanded="false" aria-controls="collapseSubKegiatan{{ $subkegiatan->id }}">
                                                                            <div class="d-flex justify-content-between w-100">
                                                                                ...
                                                                                <span class="d-flex align-items-center">
                                                                                    <span class="badge {{ $subkegiatan->aktivitas->sum('nominal') >= $subkegiatan->anggaran ? 'bg-danger' : ($subkegiatan->aktivitas->sum('nominal') >= ($subkegiatan->anggaran/2) ? 'bg-warning' : 'bg-success') }}">
